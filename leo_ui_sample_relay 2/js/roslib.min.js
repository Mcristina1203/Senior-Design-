!function a(b, c, d) {
    ...
    1: [function(a, b, c) {
        !function(a) {
            ...
            function f(a, b) {
                ...
                this.verboseMemoryLeak ? (c += " Event name: %s.", console.error(c, a, b)) : console.error(c, a),
            ...
            function h(a, b, c, d) {
                ...
                if ("*" === o || "**" === o || c[o]) {
                    ...
                    if ("**" === o) {
                        ...
                        for (g in c)
                            "_listeners" !== g && c.hasOwnProperty(g) && ("*" === g || "**" === g ? (c[g]._listeners && !l && (m = m.concat(h(a, b, c[g], n))), m = m.concat(h(a, b, c[g], d))) : m = g === p ? m.concat(h(a, b, c[g], d + 2)) : m.concat(h(a, b, c[g], d)));
                        return m
                    }
                ...
                if (i = c["*"], i && h(a, b, i, d + 1), j = c["**"])
                    if (d < n) {
                        ...
                        for (g in j)
                            "_listeners" !== g && j.hasOwnProperty(g) && (g === p ? h(a, b, j[g], d + 2) : g === o ? h(a, b, j[g], d + 1) : (k = {}, k[g] = j[g], h(a, b, {
                                "**": k
                            }, d + 1)))
                    } else
            ...
            function i(b, c) {
                ...
                for (var g = this.listenerTree, h = b.shift(); h !== a;) {
                    if (g[h] || (g[h] = {}), g = g[h], 0 === b.length)
                        return g._listeners ? ("function" == typeof g._listeners && (g._listeners = [g._listeners]), g._listeners.push(c), !g._listeners.warned && this._events.maxListeners > 0 && g._listeners.length > this._events.maxListeners && (g._listeners.warned = !0, f.call(this, g._listeners.length, h))) : g._listeners = c, !0;
                    h = b.shift()
                }
                return !0
            }
                ...
                if (this._all) {
                    if (j > 3)
                        for (b = new Array(j), f = 1; f < j; f++)
                            b[f] = arguments[f];
                    for (e = 0, c = this._all.length; e < c; e++)
            ...
            g.prototype.offAny = function(a) {
                ...
                if (a && this._all && this._all.length > 0) {
                    for (b = this._all, c = 0, d = b.length; c < d; c++)
                        if (a === b[c])
                            return b.splice(c, 1), this.emit("removeListenerAny", a), this
                } else {
                    for (b = this._all, c = 0, d = b.length; c < d; c++)
            ...
            g.prototype.removeAllListeners = function(a) {
                if (0 === arguments.length)
                    return !this._events || d.call(this), this;
                if (this.wildcard)
    ...
    17: [function(a, b, c) {
        function d(a) {
            ...
            this.throttle_rate < 0 && (this.emit("warning", this.throttle_rate + " is not allowed. Set to 0"), this.throttle_rate = 0);
            var b = this;
        ...
        d.prototype.subscribe = function(a) {
            ...
            this.subscribeId || (this.ros.on(this.name, this._messageCallback), this.subscribeId = "subscribe:" + this.name + ":" + ++this.ros.idCounter, this.callForSubscribeAndAdvertise({
                op: "subscribe",
                id: this.subscribeId,
    ...
    25: [function(a, b, c) {
        ...
        d.prototype.subscribe = function(a, b) {
            ...
            this.frameInfos[a] ? this.frameInfos[a].transform && b(this.frameInfos[a].transform) : (this.frameInfos[a] = {
                cbs: []
            }, this.republisherUpdateRequested || (setTimeout(this.updateGoal.bind(this), this.updateDelay), this.republisherUpdateRequested = !0)),
